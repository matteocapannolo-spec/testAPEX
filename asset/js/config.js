...
const GENERIC_TICKET_CATEGORIES = {
    prodotto_mancante: { label: 'Prodotto da inserire' },
    modifiche_gruppo: { label: 'Modifiche gruppo di prodotti' },
    bug: { label: "Bug dell'applicazione" },
    feature: { label: 'Richiesta Feature / Suggerimento' }
};
...
const SI_NO_COLUMNS = [
    'Datasheet Doc [ENG]', 'PDF Datasheet [ENG]', 'CE', 'Render Ambientali', 'Serigrafia',
    'Originale', 'Originale ITA'
];

const ORIGINALE_COLUMNS = ['Originale', 'Originale ITA'];
...
const DASHBOARDS = {
    visual_design: {
        ...
        columns: [
            ...
            'Docs', 'Folder Datasheet', 'Datasheet Doc [ENG]', 'PDF Datasheet [ENG]', 'Datasheet Doc [ITA]', 'PDF Datasheet [ITA]', 'QR CODE ITA', 'QR CODE ENG', 'CE',
        ...
        sectionsConfig: {
            ...
            "sec_3": { motherCols: ['Docs'], childCols: ['Folder Datasheet', 'Datasheet Doc [ENG]', 'PDF Datasheet [ENG]', 'Datasheet Doc [ITA]', 'PDF Datasheet [ITA]', 'QR CODE ITA', 'QR CODE ENG', 'CE'], isExpanded: false },
    ...
    industrial: {
        ...
        type: 'product_table',
        columns: [
            'Brand Prodotto', 'Nome Prodotto', 'Stato Globale', 'Tickets', 'Miniatura', 'Versione Prodotto', 'Codice Univoco', 'Categoria Prodotto', 'Applicazioni',
            'Su sito', 'Pagina Web ITA', 'Pagina Web ENG', 'Descrizione Meta ITA', 'Descrizione Meta ENG', 'Note/WebSite',
            'Docs', 'Folder Datasheet', 'Datasheet Doc [ENG]', 'PDF Datasheet [ENG]', 'Datasheet Doc [ITA]', 'PDF Datasheet [ITA]', 'QR CODE ITA', 'QR CODE ENG', 'CE', 'Originale', 'Originale ITA',
            'Visual', 'Immagini Prodotto', 'Foto Principale', 'foto formato Webp', 'Render Ambientali', 'Serigrafia',
            'Versioni Alternative', 'PersonalCol1', 'PersonalCol2', 'PersonalCol3', 'In Catalogo'
        ],
        sectionsConfig: {
            "sec_1": { motherCols: ['Brand Prodotto', 'Nome Prodotto', 'Stato Globale', 'Tickets', 'Miniatura', 'Versione Prodotto'], childCols: ['Codice Univoco', 'Categoria Prodotto', 'Applicazioni'], isExpanded: false },
            "sec_2": { motherCols: ['Su sito'], childCols: ['Pagina Web ITA', 'Pagina Web ENG', 'Descrizione Meta ITA', 'Descrizione Meta ENG', 'Note/WebSite'], isExpanded: false },
            "sec_3": { motherCols: ['Docs'], childCols: ['Folder Datasheet', 'Datasheet Doc [ENG]', 'PDF Datasheet [ENG]', 'Datasheet Doc [ITA]', 'PDF Datasheet [ITA]', 'QR CODE ITA', 'QR CODE ENG', 'CE', 'Originale', 'Originale ITA'], isExpanded: false },
            "sec_4": { motherCols: ['Visual'], childCols: ['Immagini Prodotto', 'Foto Principale', 'foto formato Webp', 'Render Ambientali', 'Serigrafia'], isExpanded: false }
        },
